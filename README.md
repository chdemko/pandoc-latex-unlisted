...
[![Build Status](https://img.shields.io/travis/chdemko/pandoc-latex-unlisted/0.0.1.svg)](https://travis-ci.org/chdemko/pandoc-latex-unlisted/branches)
[![Coveralls](https://img.shields.io/coveralls/github/chdemko/pandoc-latex-unlisted/0.0.1.svg)](https://coveralls.io/github/chdemko/pandoc-latex-unlisted?branch=0.0.1)
...
[![PyPI format](https://img.shields.io/pypi/format/pandoc-latex-unlisted/0.0.1.svg)](https://pypi.org/project/pandoc-latex-unlisted/0.0.1/)
[![License](https://img.shields.io/pypi/l/pandoc-latex-unlisted/0.0.1.svg)](https://raw.githubusercontent.com/chdemko/pandoc-latex-unlisted/0.0.1/LICENSE)
